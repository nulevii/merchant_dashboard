...
import { setStep, addAccountInfo } from '../../../../store/actions'
...
function StageOne (): JSX.Element {
  ...
  return (
    <>
      ...
      <p className='text-center leading-[18px] text-Shade40'>Already have an account? <a className='text-ChadBlue0' onClick={onLogin} href="#">Login</a> </p>
    </>
  )
}
